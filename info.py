...
API_ID = os.environ.get("API_ID", 123456)  # अपना API ID यहाँ डालें
...
# Other
ADMINS = [int(admin) for admin in os.environ.get("ADMINS", "123456789").split()] # अपनी Telegram User ID यहाँ डालें (ये एडमिन होगी)
